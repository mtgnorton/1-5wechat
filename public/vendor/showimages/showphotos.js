...
',
  ...
  let manager = new Vue({
    ...
    mounted: function () {
      this.getImages();
      this.submitImagePath = window.selectedImage;
      if(this.submitImagePath.indexOf(',')){
        this.showImagesData = this.submitImagePath.split(',');
      }else{
        this.showImagesData = [this.submitImagePath];
      }
      console.log(this.showImagesData.length,'aaa');
